...
async function run() {
  try {
    ...
    const bookedDestinationCollection = client
      .db("TravelGuide")
      .collection("booking");
    ...
    app.post("/bookedDestination", verifyJWT, async (req, res) => {
      ...
      const result = await bookedDestinationCollection.insertOne(
        confirmBooking
      );
    ...
    app.get("/booking", verifyJWT, async (req, res) => {
      ...
      if (email === decodedEmail) {
        ...
        const bookings = await bookedDestinationCollection
          .find(query)
          .toArray();
    ...
    app.patch("/booking/:id", verifyJWT, async (req, res) => {
      ...
      const updatedBooking = await bookedDestinationCollection.updateOne(
        filter,
        updatedDoc
      );
